...
title: ドキュメント
---
Hexoのドキュメントへようこそ。もしHexoの使用中に問題が発生した時は, [トラブルシュート](troubleshooting.html)で問題を探すか, [GitHub](https://github.com/hexojs/hexo/issues) もしくは [Google Group](https://groups.google.com/group/hexo) で質問してください。

## Hexoとは？

Hexoはレスポンスが高速でかつシンプルで強力なブログ構築のフレームワークです。 [Markdown](http://daringfireball.net/projects/markdown/) (もしくは他のMarkup言語)で記事を作成すれば、Hexoが瞬時に綺麗なテーマで静的ファイルを生成します。
